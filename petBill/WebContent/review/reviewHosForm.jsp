...
<body>
	...
	<table> 
		<%--<tr>
		<td><input type="hidden" name = "reviewId" value = "<%=article.getReviewId()%>"/></td>
		</tr>--%>
		<tr>
		<td><input type="hidden" name = "reviewNo" value = "<%=dto.getReviewNo()%>"/></td>
		</tr>
		<tr>
			<td align="left">제목 <input type="text" name="reviewSubject" value="<%=dto.getReviewSubject() %>"/></td>
		</tr>
		<tr>
		...
		<td>
			<%if(dto.getReviewPhoto() != null){ // 사진 저장된게 있을 경우
					System.out.println(dto.getReviewPhoto());%>
   	 ...
   	 <table>
		<tr>
		<td><textarea rows="20" cols="40" name="reviewRef"></textarea></td>
		</tr>
		<tr>		
			<td>
				<input type="submit" value="답글달기"/>
				<input type="reset" value="재작성" />
				<input type="button" value="삭제" onclick="window.location='reviewDeleteForm.jsp'" />
			</td>
		</tr> 
	</table> 
	</form>
